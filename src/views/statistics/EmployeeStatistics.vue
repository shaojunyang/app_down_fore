        ...
        >
            ...
            <el-table-column type="expand">
                <template slot-scope="props">
                    <el-table
                            :key="tableKey"
                            :data="props.row.listEmployeeVoList"
                            border
                            fit
                            highlight-current-row
                    >
                        <el-table-column label="员工姓名" prop="name" width="200px" align="center">
                            <template slot-scope="scope">
                        ...
                        <el-table-column label="手机号" prop="name" width="200px" align="center">
                            <template slot-scope="scope">
                        ...
                        <el-table-column label="所属部门" prop="name" width="200px" align="center">
                            <template slot-scope="scope">
            ...
            <el-table-column :label="$t('公司名称')" prop="companyName" width="900px" align="center" sortable>
                <template slot-scope="scope">
...
<script>
    ...
    import {downloadExcelFileApi, startOrDisabledApi, testAES} from "../../api/article";
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                ...
                // testAES().then(response => {
                //     console.log("test:");
                //     console.log(":", response);
                // str = Decrypt(response.data)
                // console.log("str:", str);
            ...
            exportList() {
                ...
                downloadExcelFileApi(href).then(res => {
                    const fileName = "员工列表_" + new Date().getTime().toString() + ".xlsx"

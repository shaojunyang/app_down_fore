        ...
        >
            ...
            <el-table-column type="expand">
                <template slot-scope="props">
                    <el-table
                            :key="tableKey"
                            :data="props.row.listAdmin"
                            border
                            fit
                            highlight-current-row
                    >
                        <el-table-column label="管理员姓名" prop="name" width="200px" align="center">
                            <template slot-scope="scope">
                        ...
                        <el-table-column label="类型" prop="name" width="200px" align="center">
                            <template slot-scope="scope">
                                <span>{{ scope.row.adminType === 0 ? '超级管理员' :'普通管理员' }}</span>
                            </template>
                        </el-table-column>
            ...
            <el-table-column align="center" label='编号' prop="id" width="90px" sortable>
                <template slot-scope="scope">
            ...
            <el-table-column :label="$t('公司名称')" prop="companyName" width="330px" align="center" sortable>
                <template slot-scope="scope">

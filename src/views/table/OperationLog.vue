<template>
    <div class="app-container">
        <div class="filter-container">
            <el-input placeholder="输入操作名称" v-model="listQuery.keyword" style="width: 200px;"
            ...
            <span class="demonstration" style="margin-left: 20px; margin-bottom: 10px;">时间筛选</span>
            <el-date-picker
                    v-model="dateangeValue"
                    type="datetimerange"
        ...
        >
            ...
            <!--</template>-->
            <!--</el-table-column>-->
            <el-table-column align="center" label='编号' width="100px" sortable>
                <template slot-scope="scope">
                    {{((listQuery.pageNum-1)*listQuery.pageSize)+scope.$index + 1}}
                </template>
            </el-table-column>
            <el-table-column :label="$t('操作人')" width="150px" align="center" sortable>
                <template slot-scope="scope">
                    <span>{{ scope.row.requestUserName }}</span>
                </template>
            </el-table-column>
            <el-table-column label="操作内容" min-width="250px" sortable>
                <template slot-scope="scope">
            ...
            <!--<el-table-column label="操作数据" min-width="250px" sortable>-->
            <!--<template slot-scope="scope">-->

            <!--<el-tag type="primary">查看数据</el-tag>-->
            <!--&lt;!&ndash;<span class="link-type" @click="handleUpdate(scope.row)">{{  }}</span>&ndash;&gt;-->
            <!--&lt;!&ndash;<el-tag>{{ // scope.row.type | typeFilter }}</el-tag>&ndash;&gt;-->
            <!--</template>-->
            <!--</el-table-column>-->

            <el-table-column prop="params" label="操作数据 " sortable width="120">
                <template slot-scope="scope">
                    <el-tag type="primary">查看数据</el-tag>
                </template>
            </el-table-column>

            <el-table-column label="操作时间" width="150px" align="center" sortable>
                <template slot-scope="scope">
            ...
            <el-table-column label="操作公司" min-width="250px" sortable>
                <template slot-scope="scope">

                    <span>{{ scope.row.requestCompanyName }}</span>
                    <!--<span class="link-type" @click="handleUpdate(scope.row)">{{ scope.row.description }}</span>-->
                    <!--<el-tag>{{ scope.row.type | typeFilter }}</el-tag>-->
                </template>
            </el-table-column>

            <el-table-column label="请求Ip" min-width="150px" sortable>
                <template slot-scope="scope">
            ...
            <!--<el-table-column label="更新时间" width="150px" align="center" sortable>-->
            <!--<template slot-scope="scope">-->
        ...
        <!--</el-table>-->
        <!--</el-dialog>-->
        <el-dialog @dragDialog="" v-el-drag-dialog :visible.sync="dialogPvVisible" title="操作数据">
...
<script>
    ...
    import {fetchList, fetchPv, createArticle, updateArticle, companyList, logList} from '@/api/article'
    ...
    export default {
        ...
        data() {
            return {
                ...
                listQuery: {
                    pageSize: 10,
                    pageNum: 1,
                    // dateangeStartValue: undefined,
                    // dateangeEndValue: undefined,

                    // dateangeStartValue: this.dateangeValue[0],
                    // dateangeEndValue: this.dateangeValue[1],
                    // limit: 20,
        ...
        methods: {
            ...
            getList() {
                console.log("this.dateangeValue:" , this.dateangeValue);
                this.listQuery.dateangeStartValue= this.dateangeValue[0]
                this.listQuery.dateangeEndValue= this.dateangeValue[1]
